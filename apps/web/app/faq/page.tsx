...
const FAQS = [
  ...
  {
    q: "What's the difference between the three campaign types?",
    a: "Clipping means re-cutting and posting a video the brand already supplied. Creator Content means producing something original from a brief. Product Review means receiving a physical product and reviewing it once it arrives.",
  },
  {
