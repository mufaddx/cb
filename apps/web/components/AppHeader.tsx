...
/** Shared top nav for brand/creator pages (not the admin console, which
 * has its own sidebar). Self-fetches which nav to show via
 * /api/auth/me so every page just renders <AppHeader /> with no props
 * to plumb through. */
